...
/**
 NODE CONSOLE
 var deployed
 methods.deployContract("flipper").then(result => { deployed = result })
 deployed.methods
 :)

 > deployed.methods.currentState().call().then(console.log)
Promise {
  _bitField: 0,
...
> 0
// 0 is the index of the element in the GameState enum



> deployed.methods.transitionGameState("wagerMade").call()
> deployed.methods.transitionGameState("wagerMade", {from:buyer}).call()
 */