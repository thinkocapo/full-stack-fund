contract Lottery {
    ...
    function selectWinner() {
        ...
        // take 1% and send to the house/owner
        // ...
...
contract MasterContract {
    ...
    function changeowner (address _owner) private {
        if (msg.sender == owner) {
            owner = _owner;
        }
    }
    ...
    function createLottery(uint _etherContribution, uint _maxPlayers) payable {
        ...
        lotteries[address(newLottery)] = newLottery;
    }
    // OR
    ...
    function addPlayer (address lotteryAddress, uint _etherContribution, uint _maxPlayers) payable {
        ...
        address(lottery).send(msg.value); // arrive at MasterContract, then immediately leaves... WORKS
        //or
